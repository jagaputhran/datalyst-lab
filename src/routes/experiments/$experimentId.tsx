...
function ExperimentDetail() {
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="rounded-2xl border border-info/25 bg-info/5 p-4 sm:p-5">
        <div className="mb-3 flex items-center gap-2">
          <span className="grid size-7 shrink-0 place-items-center rounded-lg bg-info/15 text-info">
            <ClipboardList className="size-4" />
          </span>
          <div>
            <p className="text-xs font-semibold uppercase tracking-wider text-info">Pre-Lab</p>
            <p className="text-[11px] text-muted-foreground">Review this before you start the experiment</p>
          </div>
        </div>
        <div className="grid gap-4 md:grid-cols-2">
          <div className="rounded-xl border border-border bg-card p-4">
            <p className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-muted-foreground">
              <Lightbulb className="size-4 text-warning" /> Theory to recall
            </p>
            <p className="mt-1.5 text-sm leading-relaxed">{experiment.theory}</p>
          </div>
          <div className="rounded-xl border border-border bg-card p-4">
            <p className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-muted-foreground">
              <ListChecks className="size-4 text-info" /> By the end you should be able to
            </p>
        ...
        <div className="mt-4 rounded-xl border border-border bg-card p-4">
          <p className="mb-2 text-xs font-semibold uppercase tracking-wider text-muted-foreground">What you'll do (steps)</p>
      ...
      <section className="rounded-2xl border border-primary/25 bg-primary/5 p-4 sm:p-5">
        <div className="mb-3 flex items-center gap-2">
          ...
          <div>
            <p className="text-xs font-semibold uppercase tracking-wider text-primary">Post-Lab</p>
            <p className="text-[11px] text-muted-foreground">Consolidate what you learned after running the experiment</p>
          </div>
        </div>
        ...
        <div className="rounded-xl border border-border bg-card p-4">
          <div className="flex items-center justify-between gap-3">
            <p className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-muted-foreground">
              <Sparkles className="size-4 text-primary" /> Observation
            </p>
            {!showObservation && (
        ...
        <div className="mt-4 rounded-xl border border-border bg-card p-4">
          <p className="mb-2 text-xs font-semibold uppercase tracking-wider text-muted-foreground">Key takeaways · what you learned</p>
