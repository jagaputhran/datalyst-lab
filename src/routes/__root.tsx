  ...
  head: () => ({
    meta: [
      { charSet: "utf-8" },
       ...
       { property: "og:title", content: "DS VirtualLab | Data Science Learning" },
       { property: "og:description", content: "Learn concepts, run browser-based Python experiments, analyze CSVs and visualize data." },
